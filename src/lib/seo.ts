...
export const pages = {
  home: {
    ...
    description:
      'HKN Auto, Sakarya ve Serdivan bölgesinde motor mekanik, periyodik bakım, oto ekspertiz, elektronik arıza tespiti ve otomatik şanzıman hizmetleri sunar.',
    path: '/',
  ...
  services: {
    ...
    description:
      'Sakarya araç bakım hizmetleri: motor revizyonu, ön takım tamiri, periyodik bakım, oto elektrik, oto ekspertiz ve otomatik şanzıman çözümleri.',
    path: '/hizmetler',
    keywords: ['Sakarya araç bakım', 'araç bakım hizmetleri', 'oto ekspertiz Sakarya'],
  },
  about: {
  ...
  blog: {
    ...
    description:
      'Sakarya oto servis, araç bakım, periyodik bakım, motor mekanik ve oto ekspertiz konularında HKN Auto uzman rehberleri.',
    path: '/blog',
  ...
  contact: {
    ...
    description:
      'Sakarya oto servis randevusu için HKN Auto ile iletişime geçin. Serdivan ve Sakarya çevresinde profesyonel araç bakım hizmetleri.',
    path: '/iletisim',
    keywords: ['Serdivan oto servis', 'Sakarya oto servis', 'Sakarya araç bakım'],
  },
...
export function localBusinessSchema() {
  return {
    ...
    sameAs: ['https://wa.me/905330540436'],
  };
}
